        ...
        {
            {
                try
                {
                    string query = "INSERT INTO [Products] ([ID_products], [Drugs], [Shelflife], [Dosage], [Category], [Price], [ID_suppliers]) VALUES ('" + textBox16.Text + "','" + textBox15.Text + "','" + textBox6.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + comboBox1 + "','" + textBox24.Text + "','" + textBox25.Text + "')";
                    OleDbCommand command = new OleDbCommand(query, con);
                    command.ExecuteNonQuery();
